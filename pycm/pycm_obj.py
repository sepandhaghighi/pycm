...
class ConfusionMatrix():
    ...
    def __init__(
        ...
        self.TPR_Micro = None
        self.PPV_Micro = None
        self.Overall_RACC = None
        self.Overall_RACCU = None
        self.PI = None
        self.AC1 = None
        self.S = None
        self.Kappa_SE = None
        ...
        self.Phi_Squared = None
        self.KappaUnbiased = None
        self.KappaNoPrevalence = None
        self.V = None
        self.DF = None
        self.CI = None
        self.SE = None
        self.ReferenceEntropy = None
        self.ResponseEntropy = None
        self.CrossEntropy = None
        self.JointEntropy = None
        self.ConditionalEntropy = None
        self.MutualInformation = None
        self.KL = None
        self.LambdaB = None
        self.LambdaA = None
        self.HammingLoss = None
        self.ZeroOneLoss = None
        self.NIR = None
        self.PValue = None
        self.Overall_CEN = None
        self.Overall_MCEN = None
        self.Overall_MCC = None
        self.RR = None
        self.CBA = None
        self.AUNU = None
        self.AUNP = None
...
def __class_stat_init__(CM):
    ...
    CM.PLR = CM.class_stat["LR+"]
    CM.NLR = CM.class_stat["LR-"]
