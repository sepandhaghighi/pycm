...
>>> assert isclose(cm1.distance(metric=DistanceType.KoppenI)[1], 0.49615384615384617, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm2.distance(metric=DistanceType.KoppenI)[1], 0.3575056927658083, abs_tol=ABS_TOL, rel_tol=REL_TOL)
...
>>> assert isclose(cm1.distance(metric=DistanceType.KuderRichardson)[1], 0.8321917808219178, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm2.distance(metric=DistanceType.KuderRichardson)[1], 0.7642838731849815, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm1.distance(metric=DistanceType.KuhnsI)[1], 0.5050499791753436, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm2.distance(metric=DistanceType.KuhnsI)[1], 0.5050044252394835, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm1.distance(metric=DistanceType.KuhnsII)[1], 0.663265306122449, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm2.distance(metric=DistanceType.KuhnsII)[1], 0.5513038548752834, abs_tol=ABS_TOL, rel_tol=REL_TOL)
