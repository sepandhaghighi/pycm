...
SEABORN_PLOT_LIBRARY_ERROR = "Error in importing seaborn module. Please install it : pip install seaborn"
MATPLOTLIB_PLOT_LIBRARY_ERROR = "Error in importing matplotlib module. Please install it : pip install matplotlib"
