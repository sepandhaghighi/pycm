...
class ConfusionMatrix():
    ...
    def __init__(
        ...
        self.DP = statistic_result["DP"]
        self.Y = statistic_result["Y"]
    ...
    def relabel(self, mapping):
        ...
        self.TPR = self.class_stat["TPR"]
        self.TNR = self.class_stat["TNR"]
        self.PPV = self.class_stat["PPV"]
        self.NPV = self.class_stat["NPV"]
        self.FNR = self.class_stat["FNR"]
        self.FPR = self.class_stat["FPR"]
        self.FDR = self.class_stat["FDR"]
        self.FOR = self.class_stat["FOR"]
        self.ACC = self.class_stat["ACC"]
        self.F1 = self.class_stat["F1"]
        self.MCC = self.class_stat["MCC"]
        self.BM = self.class_stat["BM"]
        self.MK = self.class_stat["MK"]
        self.DOR = self.class_stat["DOR"]
        self.PLR = self.class_stat["LR+"]
        self.NLR = self.class_stat["LR-"]
        self.POP = self.class_stat["POP"]
        self.P = self.class_stat["P"]
        self.N = self.class_stat["N"]
        self.TOP = self.class_stat["TOP"]
        self.TON = self.class_stat["TON"]
        self.PRE = self.class_stat["PRE"]
        self.G = self.class_stat["G"]
        self.RACC = self.class_stat["RACC"]
        self.RACCU = self.class_stat["RACCU"]
        self.F2 = self.class_stat["F2"]
        self.F05 = self.class_stat["F0.5"]
        self.ERR = self.class_stat["ERR"]
        self.J = self.class_stat["J"]
        self.IS = self.class_stat["IS"]
        self.CEN = self.class_stat["CEN"]
        self.MCEN = self.class_stat["MCEN"]
        self.AUC = self.class_stat["AUC"]
        self.dInd = self.class_stat["dInd"]
