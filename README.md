...
⚠️  Plotting capability require **Matplotlib (>= 3.0.0)** or **Seaborn (>= 0.9.1)**   
...
### Plot
`plot` method is added in `version 3.0` in order to plot a confusion matrix by use of matplotlib or seaborn.
