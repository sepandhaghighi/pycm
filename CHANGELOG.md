...
- `Compare` class `save_report` method
- `ConfusionMatrix` class `save_stat` method
- `ConfusionMatrix` class `save_html` method
- `ConfusionMatrix` class `save_csv` method
- `ConfusionMatrix` class `save_obj` method
## [4.6] - 2026-03-09
### Added
- `PCurve` class
- `RCurve` class
...
- Test system modified
- Interpretation functions `NaN` bug fixed
## [4.5] - 2025-10-15
### Added
...
[Unreleased]: https://github.com/sepandhaghighi/pycm/compare/v4.6...dev
[4.6]: https://github.com/sepandhaghighi/pycm/compare/v4.5...v4.6
