...
>>> assert isclose(cm1.distance(metric=DistanceType.KoppenI)[1], 0.7480769230769231, abs_tol=ABS_TOL, rel_tol=REL_TOL)
>>> assert isclose(cm2.distance(metric=DistanceType.KoppenI)[1], 0.6787528463829041, abs_tol=ABS_TOL, rel_tol=REL_TOL)
